...
export const CAT_STYLES: Record<string, CatStyle> = {
  ...
  chore:    { text: "text-chore",    bg: "bg-chore-dim", dot: "bg-chore",    bar: "bg-chore",    accent: "border-chore", prefix: "·", label: "Chores"    },
...
export const CAT_ORDER = ["feat", "fix", "refactor", "chore", "docs", "test", "style", "other"] as const;
