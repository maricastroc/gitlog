...
const INPUT_CLS = "w-full px-4 py-3 rounded-lg bg-panel-2 border border-line text-text font-mono text-[13px] outline-none focus:border-text-dim transition-colors placeholder:text-text-dim";
